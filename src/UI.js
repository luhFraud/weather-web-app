...
import cloudyMoon from "./images/cloudy-moon.png"
    ...
    static getIcon(condition, sunrise, sunset, localtime) {
        ...
        switch (condition) {
            ...
            case 1003: // Partly cloudy
                icon = isDayTime ? cloudy : partlyCloudy;
                break;
            case 1006: // Cloudy
            case 1009: // Overcast
                icon = cloudy
            ...
            case 1282: // Moderate or heavy snow with thunder
                ...
                break;
            default:
                icon = sunny; // Default icon if condition doesn't match
                break;
        }
        return icon;
    }
    ...
    static getHourlyIcon(condition, hour, sunrise, sunset) {
        ...
        switch (condition) {
            case 1000: // Sunny / Clear
                ...
                break;
            case 1003: // Partly cloudy
                icon = isNight ? cloudyMoon : partlyCloudy;
                break;
            case 1006: // Cloudy
            case 1009: // Overcast
                icon = cloudy
